...
class DijkstraA:
    ...
    def print_shortest_path(destination_vertex):
        if destination_vertex.predecessor is not None:
            DijkstraA.print_shortest_path(destination_vertex.predecessor)
...
vertices, edges = GraphGeneratorA.generate_random_graph(num_vertices, num_edges)
